configatron.configure_from_hash(
  ...
  :app_host => "grimzmusichub.com", #override this in your application.yml

  :community_name => "Grimz Music Hub",

  :community_tagline => "Music worth paying for",
  :community_description =>  "For the love of good music",
  :support_email =>  "support@grimzmusichub.com",
  :meta_description => 'Music Worth Paying For',
  :meta_keywords => 'GMH, Music worth paying For, music community',
